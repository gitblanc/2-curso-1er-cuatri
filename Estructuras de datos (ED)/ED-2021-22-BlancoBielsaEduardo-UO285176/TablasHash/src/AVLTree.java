...
public class AVLTree<T extends Comparable<T>> {
	...
	public ArrayList<T> devolverNodos() {
		nodos = new ArrayList<>();
		if (raiz == null)
			return null;
		añadirNodosRecursivo(this.raiz);
		return nodos;
	}

	private void añadirNodosRecursivo(AVLNode<T> raiz2) {
		añadirNodosRecursivo(raiz2.getLeft());
		nodos.add(raiz2.getInfo());
		añadirNodosRecursivo(raiz2.getRight());
