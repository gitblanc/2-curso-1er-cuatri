...
public class VentanaConfirmacion extends JDialog {
	...
	/**
	 * Constructor con parámetro VentanaRegistro que crea el frame
	 */
	...
	/*
	 * Getter para el label El código de recogida es:
	 */
	...
	/*
	 * Getter para el JTextField código del pedido
	 */
	...
	/*
	 * Getter para el JButton finalizar. Realiza la acción de cerrar las ventanas.
	 */
	...
	/*
	 * Método que graba el pedido, vuelve a inicializar la ventana principal y
	 * cierra las demás ventanas
	 */
	private void finalizar() {
		vR.getVentanaPrincipal().getPedido().grabarPedido();
		vR.getVentanaPrincipal().inicializar();
		vR.dispose();
		dispose();
	}
	...
	private JLabel getLblPrecioTotal() {
		if (lblPrecioTotal == null) {
			...
			lblPrecioTotal.setBounds(320, 214, 134, 34);
		}
		return lblPrecioTotal;
	}

	/*
	 * Método que devuelve el precio sin descuento y en el caso de que se aplicase
	...
	/*
	 * Getter para el JLabel descuento, que no mostrará nada salvo que haya un
	 * descuento
	 */
