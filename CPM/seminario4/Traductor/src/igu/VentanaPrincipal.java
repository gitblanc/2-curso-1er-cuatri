...
public class VentanaPrincipal extends JFrame {
	...
	private ProcesaAr pAr = new ProcesaAr();
	private ProcesaVentana pVentana = new ProcesaVentana();
	private BorderPainter borderP = new BorderPainter();
	...
	private JButton getBtNuevo() {
		if (btNuevo == null) {
			...
			btNuevo.addMouseListener(borderP);
		}
		return btNuevo;
	}
	...
	private JButton getBtGuardar() {
		if (btGuardar == null) {
			...
			btGuardar.addMouseListener(borderP);
		}
		return btGuardar;
	}
	...
	private JButton getBtAbrir() {
		if (btAbrir == null) {
			...
			btAbrir.addMouseListener(borderP);
		}
		return btAbrir;
	}
	...
	private JButton getBtImprimir() {
		if (btImprimir == null) {
			...
			btImprimir.addMouseMotionListener(borderP);
		}
		return btImprimir;
	}
	...
	private JTextArea getArOriginal() {
		if (arOriginal == null) {
			...
			arOriginal.addFocusListener(pAr);
	...
	private JTextArea getArTraducido() {
		if (arTraducido == null) {
			...
			arTraducido.addFocusListener(pAr);
			arTraducido.setLineWrap(true);
		}
		return arTraducido;
	}

	public class ProcesaAr implements FocusListener {
	...
	public class ProcesaVentana extends WindowAdapter{
	...
	public class BorderPainter extends MouseAdapter {
	...
	public VentanaPrincipal() {
		...
		this.addWindowListener(pVentana);
	}
