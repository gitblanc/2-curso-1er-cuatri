...
public class VentanaPrincipal extends JFrame {
	...
	private JLabel getEtFoto() {
	  if (etFoto == null) {
		etFoto = new JLabel();
		etFoto.setBounds(new Rectangle(10, 11, 231, 233));
	...
	private JPanel getPanelTablero() {
		if (panelTablero == null) {
			...
			panelTablero.setBounds(new Rectangle(200, 161, 509, 72));
		...
		for (int i=0; i<botones.length;i++ )
		{
		      ...
		      if (i == juego.getPosicionFicha()){
		        ...
		        boton.setDisabledIcon(new ImageIcon("src/img/ficha.png"));}
			        ...
			        boton.setIcon(new ImageIcon("src/img/ocainicio.png"));
			        boton.setDisabledIcon(new ImageIcon("src/img/ocainicio.png"));}
		      else if (i == Tablero.OCAFIN){
			        boton.setIcon(new ImageIcon("src/img/ocafin.png"));
			        boton.setDisabledIcon(new ImageIcon("src/img/ocafin.png"));}
		      else
		    	 boton.setIcon(null);
		}
