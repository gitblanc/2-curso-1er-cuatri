...
public class VentanaPrincipal extends JFrame {
	...
	private JPanel getPanelTablero() {
		if (panelTablero == null) {
			...
			panelTablero.setBounds(new Rectangle(95, 192, 509, 72));
...
//		   }		
	...
	private JLabel getLblDonkeyKong() {
		if (lblDonkeyKong == null) {
			lblDonkeyKong = new JLabel("");
			lblDonkeyKong.setIcon(new ImageIcon(VentanaPrincipal.class.getResource("/img/DonkeyKong.png")));
			lblDonkeyKong.setBounds(638, 171, 96, 102);
		}
		return lblDonkeyKong;
	}
	private JLabel getLblVioleta() {
		if (lblVioleta == null) {
			lblVioleta = new JLabel("");
			lblVioleta.setIcon(new ImageIcon(VentanaPrincipal.class.getResource("/img/lady.gif")));
			lblVioleta.setBounds(745, 202, 36, 80);
		}
		return lblVioleta;
	}
} 
